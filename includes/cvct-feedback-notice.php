...
if (!class_exists('CVCTFreeFeedbackNotice')) {
    class CVCTFreeFeedbackNotice {
        /**
         * The Constructor
         */
   ...
   // admin notice  
    public function admin_notice_for_reviews(){
       ...
       function create_notice_content(){
        ...
        $img_path=CVCT_URL.'assets/cvct-logo.png';
        ...
        $p_link=esc_url('https://wordpress.org/support/plugin/corona-virus-cases-tracker-covid-19-tracker-lite/reviews/#new-post');
        $message="We hope our plugin help you to display Coronavirus(COVID-19) outbreak live Updates! <br/>Please give us a quick rating, it works as a boost for us to keep working on more <a href='https://coolplugins.net' target='_blank'><strong>Cool Plugins</strong></a>!<br/>";
